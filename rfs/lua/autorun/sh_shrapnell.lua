...
hook.Add("PopulateToolMenu", "RFSOptions", function()
    spawnmenu.AddToolMenuOption("Options", "Realistic Fragmentation System", "RFS Options", "Settings", "", "", function(panel)
        ...
        if isAdmin then
            ...
            panel:ControlHelp("Selecting a number higher than 500 may cause minor lag spikes and is not recommended")
            ...
            panel:ControlHelp("Sets the minimum angle required for fragments to ricochet. 0 = perpendicular to the surface. Default is 50")
